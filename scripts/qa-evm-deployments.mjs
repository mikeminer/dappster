...
const chains = [
  { id: 1, name: "Ethereum", rpc: ["https://ethereum-rpc.publicnode.com", "https://cloudflare-eth.com"] },
  { id: 8453, name: "Base", rpc: ["https://mainnet.base.org", "https://base-rpc.publicnode.com"] },
  { id: 33139, name: "ApeChain", rpc: ["https://rpc.apechain.com/http"] },
  ...
  { id: 137, name: "Polygon PoS", rpc: ["https://polygon.drpc.org", "https://polygon.publicnode.com"] },
  ...
  { id: 100, name: "Gnosis", rpc: ["https://rpc.gnosischain.com", "https://gnosis-rpc.publicnode.com"] },
  ...
  { id: 324, name: "ZKsync Era", rpc: ["https://mainnet.era.zksync.io"] },
  ...
  { id: 34443, name: "Mode", rpc: ["https://mainnet.mode.network"] },
  ...
  { id: 252, name: "Fraxtal", rpc: ["https://rpc.frax.com"] },
  { id: 1088, name: "Metis", rpc: ["https://andromeda.metis.io/?owner=1088", "https://metis-mainnet.public.blastapi.io"] },
  ...
  { id: 11155111, name: "Sepolia", rpc: ["https://sepolia.drpc.org", "https://1rpc.io/sepolia", "https://ethereum-sepolia-rpc.publicnode.com"] },
